...
import type { AgentPhotoIdentificationResult, AgentReviewResult, AgentVisualization, MaintenanceReminderInput } from '../types'
import agentHelperCapabilities from '../agentHelperCapabilities.json'
import { api, identifyPhoto } from '../api/client'
  ...
  return (
    <div className="agent">
      ...
      <div className="agentPhotoIdentify">
        <div className="label">Identify A Flower From A Photo</div>
